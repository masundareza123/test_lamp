...
import 'package:test_lamp/constant.dart';
...
class _loginScreenState extends State<loginScreen> {
  ...
  void connectDevice(){
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => HomeView(user: user.text,pass: pass.text,vhost: vhost.text,host: host.text)),
    );
  }
  void _radio() {
    setState(() {
